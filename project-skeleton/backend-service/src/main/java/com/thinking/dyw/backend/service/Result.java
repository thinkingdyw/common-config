...
private static final _Fields optionals[] = {_Fields.CAR_BRAND,_Fields.CAR_MODEL,_Fields.CAR_TYPE};
  ...
  public Result setCarBrand(String carBrand) {
  ...
  public Result setCarModel(String carModel) {
  ...
  public Result setCarType(String carType) {
  ...
  public Result setCarBrandId(long carBrandId) {
    this.carBrandId = carBrandId;
    setCarBrandIdIsSet(true);
    return this;
  }
  ...
  public Result setCarModelId(long carModelId) {
    this.carModelId = carModelId;
    setCarModelIdIsSet(true);
    return this;
  }
  ...
  public Result setCarTypeId(long carTypeId) {
    this.carTypeId = carTypeId;
    setCarTypeIdIsSet(true);
    return this;
  }
